...
const SOCIAL = [
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/conwiro',
    icon: (props: any) => (
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/conwiro/',
    icon: (props: any) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
  ...
  {
    name: 'Twitter',
    href: 'https://twitter.com/conwiro',
    icon: (props: any) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
  ...
  {
    name: 'Youtube',
    href: 'https://www.youtube.com/channel/UCtCPYos2bq8IZ2nDxmNcHkQ',
    icon: (props: any) => (
      <svg
    ...
    <footer className="bg-black" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-4xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <img className="h-10" src="/logo_conwiro.png" alt="Company name" />
      ...
      <div className="py-8 bg-footer ">
        <p className="text-base text-white text-center">
          &copy;{new Date().getFullYear()} Conwiro, Inc. All rights reserved.
        </p>
      </div>
    </footer>
  )
